...
<head>
    ...
    <title>Declaration | SEN&Eacute;TATCIVIL</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Declarations</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1><span class="table-project-n">Etat</span> de mes Declarations</h1>
                                    </div>
                                </div>
...
$sql="SELECT * from tblcertificat where UserID=:uid";
...
<?php if($row->Status==""){ ?>
<td class="bg-warning"><?php echo "Toujour en attente"; ?></td>
<?php } else { ?> 
...
<td class="bg-danger"><?php  echo htmlentities($row->Status);?></td>
            ...
            <td class="datatable-ct"><a href="view-application-detail.php?viewid=<?php echo htmlentities ($row->ID);?>" class='btn btn-primary'>Detailles</a>
                                                    </td>
                                                </tr>
                                             <?php $cnt=$cnt+1;}} ?>  
