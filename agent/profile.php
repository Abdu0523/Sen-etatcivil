...
if (strlen($_SESSION['obcsuid']==0)) {
  ...
  $add=$_POST['add'];
  $sql="update tblagent set FirstName=:fname,LastName=:lname,Address=:add where ID=:uid";
...
<head>
    ...
    <title>Profile | SEN&Eacute;TATCIVIL</title>
                                            ...
                                            <div class="col-lg-12">
                                                <div class="all-form-element-inner">
                                                    ...
                                                    <form method="post">
                                                        <?php
$uid=$_SESSION['obcsuid'];
$sql="SELECT * from  tblagent where ID=:uid";
$query = $dbh -> prepare($sql);
$query->bindParam(':uid',$uid,PDO::PARAM_STR);
$query->execute();
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-9">
                                                                        <div class="login-horizental cancel-wp pull-left">
                                                                            ...
                                                                            <button class="btn btn-sm btn-primary login-submit-cs" type="submit" name="submit">Enregistrer</button>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
