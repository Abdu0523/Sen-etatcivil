...
<head>
    ...
    <title>Registre| SEN&Eacute;TATCIVIL</title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Registre de naiss.</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>le Registre de naissance</h1>
                                    </div>
                                </div>
...
{               ?>                              <tr>
                                                  ...
                                                  <td class="datatable-ct"><a href="certificates.php?viewid=<?php echo htmlentities ($row->ID);?>"><button class="btn btn-white btn-action btn-xs"><i class="fa fa-folder"></i> Detailles</button></a></td>
                                                </tr>
                                             <?php $cnt=$cnt+1;}} ?>  
