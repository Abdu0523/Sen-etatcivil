...
if($_GET['del']){
$appid=$_GET['del'];
$sql= "delete from tblagent where ID='$appid';
delete from tblcertificat where UserID='$appid';";
...
<head>
    ...
    <title>Utilisateurs | SEN&Eacute;TATCIVIL</title>
...
$sql="SELECT * from tblagent where Status='Actif' ";
...
{               ?>
                                                <tr>
                                                    ...
                                                    <td class="datatable-ct">
                                                      <a href="users-applications.php?userid=<?php echo htmlentities ($row->ID);?>&&fname=<?php  echo htmlentities($row->FirstName);?>" class="btn btn-primary" >Voir Activités</a>
                                                    </td>
                                                </tr>
                                             <?php $cnt=$cnt+1;}} ?>  
