...
<head>
    ...
    <title>Recherhe | SEN&Eacute;TATCIVIL</title>
                                    ...
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                         ...
                                         <form method="post">
                                                        ...
                                                        <div class="form-group-inner">
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    <label class="login2 pull-right pull-right-pro">Veuillez saisir le mot_cl&eacute; : </label>
                                                                </div>
                                                                <div class="col-lg-5">
                                                                     <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Numero de registre ou Nom de L'individu">
                                                                </div>
                                                            </div>
                                                        </div>
...
$sql="SELECT * from tblcertificat where ApplicationID like '$sdata%'  || FullName like '$sdata%' || NameofFather like '$sdata%' || NameofFather like '$sdata%'";
...
{               ?>
                     ...
                     <td class="bg-warning"><?php echo "Toujours en attente"; ?></td>
                     <?php }else{ ?>
                      <?php if($row->Status=="Approuvé"){ ?>

                     <td class="bg-success"><?php echo htmlentities($row->Status); ?></td>
                      <?php } else { ?>
                        <td class="bg-danger"><?php  echo htmlentities($row->Status);?>
                  </td>
                  <?php } }?>
