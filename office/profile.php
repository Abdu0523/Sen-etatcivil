...
if (strlen($_SESSION['obcsaid']==0)) {
  ...
  $add=$_POST['add'];
  $sql="update tbloffice set FirstName=:fname,LastName=:lname,Address=:add where ID=:aid";
...
<head>
    ...
    <title>Profil | SEN&Eacute;TATCIVIL</title>
...
<?php
$uid=$_SESSION['obcsaid'];
$sql="SELECT * from  tbloffice where ID=:aid";
$query = $dbh -> prepare($sql);
$query->bindParam(':aid',$uid,PDO::PARAM_STR);
$query->execute();
