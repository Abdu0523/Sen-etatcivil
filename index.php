...
<body >
  ...
  <section id="hero-fullscreen" class="hero-fullscreen d-flex align-items-center"style=>
    <div class="container d-flex flex-column align-items-center position-relative text-center" data-aos="zoom-out">
      <h2>Bienvenu sur le systeme de déclaration <br>de <span>naissance </span>en ligne </h2>
      <p>Déclarer votre enfant sans vous deplacer de votre fauteuil.</p>
      <div class="d-flex">
        <a href="certificat-form.php" class="btn-get-started scrollto">Commencer les démarches</a>
      </div>
    </div>
  </section>
        ...
        <div class="row gy-4">
          ...
          <div class="col-xl-3 col-md-6 d-flex" data-aos="zoom-out" data-aos-delay="200">
            <div class="service-item position-relative">
              ...
              <h4><a href="certificat-form.php" class="stretched-link">Déclarer votre Enfant</a></h4>
              <p>"Officialisez la naissance de votre enfant en quelques clics avec notre service de déclaration simplifié en ligne."</p>
            </div>
          </div><!-- End Service Item -->
