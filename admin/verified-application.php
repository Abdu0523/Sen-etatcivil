                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Certificats Approuv&eacute;s</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Certificats Approuv&eacute;s</h1>
                                    ...
                                    <div class="datatable-dashv1-list custom-datatable-overright">
                                        <div id="toolbar">
                                            <select class="form-control">
                                                <option value="all">Toutl</option>
                                                <option value="selected">S&eacute;lectionn&eacute;es</option>
                                            </select>
                                        </div>
