...
if($_GET['del']){
$appid=$_GET['del'];
$sql= "delete from tblcertificat where ID='$appid'";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">Certificats</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Certificats de Naissance</h1>
...
{               ?>
                     ...
                     <td class="bg-warning"><?php echo "En attente"; ?></td>
...
<a href="certificats.php?del=<?php echo htmlentities($row->ID);?>" onclick="return confirm('Do you really want to delete?');" class="btn btn-danger">Suppr</a>
