...
if(isset($_POST['submit']))
  {
    ...
    $mobno=$_POST['mobno'];
    $add=$_POST['address'];
    $ret="select MobileNumber from tblagent where MobileNumber=:mobno";
...
if($query -> rowCount() == 0)
{
$sql="Insert Into tblagent(FirstName,LastName,MobileNumber,Address)Values(:fname,:lname,:mobno,:add)";
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">+ agent</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                        ...
                        <form class="adminpro-form" method="post">
                            ...
                            <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1>Ajouter un Agent d'&eacute;tat civil</h1>
                                    </div>
                                </div>
                            <div class="login-bg">
