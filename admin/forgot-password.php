...
echo "<script>alert('Email ou Telephone non valide');</script>"; 
}
}
                                ...
                                <div class="login-bg">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="logo">
                                               ...
                                               <hr>
                                               <h3 style="font-weight: bold;color: #2596be"> R&eacute;initialiser Mot de passe </h3>
                                               <hr />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="text" name="mobile" placeholder="Télephone" required="true">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input type="password" name="newpassword" placeholder="Nouveau" required="true"/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-input-area">
                                                <input class="form-control" type="password" name="confirmpassword" placeholder="Confirmer" required="true" />
                                                <i class="fa fa-lock login-user" aria-hidden="true"></i>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-8">
                                            <div class="login-button-pro">
                                                ...
                                                <button type="submit" class="login-button login-button-lg" name="submit">R&eacute;initialiser</button>
